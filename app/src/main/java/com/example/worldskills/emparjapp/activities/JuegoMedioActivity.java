...
public class JuegoMedioActivity extends AppCompatActivity {
    ...
    private void cargarParejas() {
        ...
        im8 =R.drawable.s_20;
        im9=R.drawable.s_30;
        im10=R.drawable.s_40;
        im11=R.drawable.s_50;
        im12=R.drawable.s_60;
    ...
    private void inicializarElementosUI() {
        ...
        img1=findViewById(R.id.img_medio_1);
        img2=findViewById(R.id.img_medio_2);
        img3=findViewById(R.id.img_medio_3);
        img4=findViewById(R.id.img_medio_4);
        img5=findViewById(R.id.img_medio_5);
        img6=findViewById(R.id.img_medio_6);
        img7=findViewById(R.id.img_medio_7);
        img8=findViewById(R.id.img_medio_8);
        img9=findViewById(R.id.img_medio_9);
        img10=findViewById(R.id.img_medio_10);
        img11=findViewById(R.id.img_medio_11);
        img12=findViewById(R.id.img_medio_12);
    ...
    private void verificarUltimaCarta() {
        if (img1.getVisibility()==View.INVISIBLE &&
            ...
            Constantes.dialogResultados(JuegoMedioActivity.this,message);
